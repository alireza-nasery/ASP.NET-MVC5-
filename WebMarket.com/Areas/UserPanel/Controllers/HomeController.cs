...
namespace WebMarket.com.Areas.UserPanel.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult ProfileComplete(int id)
        {
            ...
            ViewBag.PageTitle = "ویرایش پروفایل";
        ...
        public ActionResult ProfileComplete(EditUserViewModel ViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    {
                        //update view model
                        ViewModel.Picture64 = temp==null ? ViewModel.Picture64 : Convert.ToBase64String(temp);

                        ViewBag.Result = 100;
                        ViewBag.Icon = "";
                        ViewBag.Message = "اطلاعات مورد نظر  شما با موفقیت تغییر داده شد";
